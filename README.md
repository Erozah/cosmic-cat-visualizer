...
│   ├── keybindings.js        # Raccourcis clavier globaux (A, C, T, F)
...
| Raccourci | Action |
| :--- | :--- |
| <kbd>A</kbd> | Activer / Mettre en pause le visualiseur |
| <kbd>C</kbd> | Alterner le modèle félin (**Cyber Cat** ⇄ **Cosmic Cat**) |
