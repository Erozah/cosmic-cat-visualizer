...
(function() {
    ...
    function initCyberCatVisualizer() {
        ...
        // 3. Mount UI Controls
        mountControlBar(getEngine);
        mountPlaybarButton(getEngine);
